let po = {
  ...
  prop: {
    fullName: {
      ...
      b5: "{0} Initial Cold",
      b6: "{0} Initial Toxin",
      b7: "{0} Initial Electricity",
      b8: "{0} Initial Impact",
      b9: "{0} Initial Puncture",
      bA: "{0} Initial Slash",
      bM: "{0} Initial Magnetic",
      bR: "{0} Initial Radiation",
    ...
    shortName: {
      ...
      b5: "Initial Cold",
      b6: "Initial Toxin",
      b7: "Initial Electricity",
      b8: "Initial Impact",
      b9: "Initial Puncture",
      bA: "Initial Slash",
      bM: "Initial Magnetic",
      bR: "Initial Radiation",
      ...
      bl: "Bleedout Link",
      vl: "Lifesteal Link",
      cl: "Critical Chance Link",
      rl: "Companion Lifesteal-Link",
      pl: "Status-Link",
      gd: "Recover Shield",
      every: "everys",
      over: "over",
      cold: "colddown",
      rh: "Recover Health",
      cs: "Shield with Health",
      ws: "Warframe Shield",
      wr: "Warframe Shield Recharge",
      va: "Collect items",
      wrm: "Every after Wall Running",
      ava: "jump height of owner",
      an: "attack enemy",
      ivt: "gain invulnerability",
      reg: "regenerate times",
      rmh: "HP Regen",
      chf: "chance to",
      rd: "reflect {0} damage",
  ...
  buff: {
    ...
    kuvaHeat: "Kuva (Heat)",
    kuvaCold: "Kuva (Cold)",
    kuvaToxin: "Kuva (Toxin)",
    kuvaElectricity: "Kuva (Electricity)",
    kuvaImpact: "Kuva (Impact)",
    kuvaMagnetic: "Kuva (Magnetic)",
    kuvaRadiation: "Kuva (Radiation)",
