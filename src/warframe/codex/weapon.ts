...
export const GunWeaponDataBase: GunWeapon[] = ([
  ...
  { id: "Staticor", name: "staticor", tags: ["Gun", "Secondary"], dmg: [["Radiation", 132]], accuracy: 16.7, fireRate: 3.5, critChance: 0.14, critMul: 2.2, status: 0.28, magazine: 48, reload: 1.5, ammo: 270, prjSpeed: 70 },
