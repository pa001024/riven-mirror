...
export const GunWeaponDataBase: GunWeapon[] = ([
  ...
  { id: "MK1-Paris", name: "mk1Paris", rivenName: "Paris", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 9], ["Puncture", 49], ["Impact", 3]], accuracy: 16.7, fireRate: 1.67, critChance: 0.3, critMul: 1.5, status: 0.1, magazine: 1, reload: 0.6, ammo: 72, prjSpeed: 70 },
  { id: "MK1-Paris (charged)", name: "mk1Paris", mode: "charged", rivenName: "Paris", tags: ["Gun", "Primary", "Rifle", "Bow", "Charge"], dmg: [["Slash", 18], ["Puncture", 96], ["Impact", 6]], accuracy: 16.7, fireRate: 2, critChance: 0.3, critMul: 2, status: 0.1, magazine: 1, reload: 0.6, ammo: 72, prjSpeed: 85 },
  ...
  { id: "Angstrum", name: "angstrum", tags: ["Gun", "Secondary", "SecondUnique"], dmg: [["Blast", 450]], accuracy: 26.7, fireRate: 1, critChance: 0.16, critMul: 2, status: 0.22, magazine: 3, reload: 2.5, ammo: 18, prjSpeed: 150 },
  ...
  { id: "Argonak", name: "argonak", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 26.2], ["Puncture", 6.3], ["Impact", 24.5]], accuracy: 28.6, fireRate: 4.33, critChance: 0.09, critMul: 1.5, status: 0.27, magazine: 43, reload: 2.4, ammo: 540 },
  { id: "Argonak (semi-auto)", name: "argonak", rivenName: "Argonak", mode: "semiAuto", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 26.2], ["Puncture", 6.3], ["Impact", 24.5]], accuracy: 28.6, fireRate: 4.33, critChance: 0.27, critMul: 2.3, status: 0.19, magazine: 43, reload: 2.4, ammo: 540 },
  ...
  { id: "Burston", name: "burston", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 10], ["Puncture", 10], ["Impact", 10]], accuracy: 25, fireRate: 8.197, critChance: 0.06, critMul: 1.6, status: 0.18, magazine: 45, reload: 2, ammo: 540 },
  { id: "Burston Prime", name: "burstonPrime", rivenName: "Burston", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 14.4], ["Puncture", 10.8], ["Impact", 10.8]], accuracy: 25, fireRate: 8.573, critChance: 0.18, critMul: 1.8, status: 0.3, magazine: 45, reload: 2, ammo: 540 },
  ...
  { id: "Castanas", name: "castanas", tags: ["Gun", "Secondary", "SecondUnique"], dmg: [["Electricity", 160]], accuracy: 100, fireRate: 5, critChance: 0.08, critMul: 1.5, status: 0.22, magazine: 2, reload: 1, ammo: 18, prjSpeed: 30 },
  { id: "Sancti Castanas", name: "sanctiCastanas", rivenName: "Castanas", tags: ["Gun", "Secondary", "SecondUnique"], dmg: [["Electricity", 300]], accuracy: 100, fireRate: 5, critChance: 0.23, critMul: 2, status: 0.34, magazine: 2, reload: 1, ammo: 18, prjSpeed: 30 },
  { id: "Cernos", name: "cernos", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 5.5], ["Puncture", 5.5], ["Impact", 99]], accuracy: 16.7, fireRate: 1.67, critChance: 0.18, critMul: 1.5, status: 0.18, magazine: 1, reload: 0.6, ammo: 72 },
  ...
  { id: "Cernos Prime", name: "cernosPrime", rivenName: "Cernos", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 9], ["Puncture", 9], ["Impact", 162]], accuracy: 16.7, bullets: 3, fireRate: 1, critChance: 0.35, critMul: 2, status: 0.3, magazine: 1, reload: 1, ammo: 72 },
  { id: "Cernos Prime (charged)", name: "cernosPrime", rivenName: "Cernos", mode: "charged", tags: ["Gun", "Primary", "Rifle", "Bow", "Charge"], dmg: [["Slash", 6], ["Puncture", 6], ["Impact", 108]], accuracy: 16.7, bullets: 3, fireRate: 2, critChance: 0.35, critMul: 2, status: 0.1, magazine: 1, reload: 0.65, ammo: 72 },
  ...
  { id: "Dex Sybaris", name: "dexSybaris", rivenName: "Sybaris", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 33.75], ["Puncture", 18.75], ["Impact", 22.5]], accuracy: 28.6, fireRate: 4.264, critChance: 0.35, critMul: 2, status: 0.1, magazine: 14, reload: 1.5, ammo: 540 },
  ...
  { id: "Grinlok", name: "grinlok", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 74.8], ["Puncture", 18.7], ["Impact", 93.5]], accuracy: 28.6, fireRate: 1.7, critChance: 0.15, critMul: 2.5, status: 0.35, magazine: 9, reload: 1.7, ammo: 540 },
  ...
  { id: "Hind", name: "hind", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 15], ["Puncture", 7.5], ["Impact", 7.5]], accuracy: 33.3, fireRate: 7.693, critChance: 0.07, critMul: 1.5, status: 0.15, magazine: 65, reload: 2, ammo: 540 },
  ...
  { id: "Javlok", name: "javlok", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Heat", 280]], accuracy: 100, fireRate: 3.33, critChance: 0.2, critMul: 2, status: 0.25, magazine: 6, reload: 1.9, ammo: 540, prjSpeed: 60 },
  { id: "Karak", name: "karak", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 7.3], ["Puncture", 8.7], ["Impact", 13]], accuracy: 28.6, fireRate: 11.7, critChance: 0.09, critMul: 1.5, status: 0.15, magazine: 30, reload: 2, ammo: 540 },
  { id: "Karak Wraith", name: "karakWraith", rivenName: "Karak", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 7.8], ["Puncture", 9.3], ["Impact", 14.1]], accuracy: 28.6, fireRate: 11.7, critChance: 0.13, critMul: 2, status: 0.25, magazine: 60, reload: 2, ammo: 540 },
  ...
  { id: "Lanka", name: "lanka", tags: ["Gun", "Primary", "Rifle", "Sniper"], dmg: [["Electricity", 200]], accuracy: 16.7, fireRate: 1, critChance: 0.25, critMul: 2, status: 0.25, magazine: 10, reload: 2, ammo: 72, prjSpeed: 200 },
  ...
  { id: "Latron", name: "latron", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 8.2], ["Puncture", 38.5], ["Impact", 8.3]], accuracy: 28.6, fireRate: 4.17, critChance: 0.12, critMul: 2, status: 0.12, magazine: 15, reload: 2.4, ammo: 540 },
  ...
  { id: "Latron Wraith", name: "latronWraith", rivenName: "Latron", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 3], ["Puncture", 42], ["Impact", 15]], accuracy: 28.6, fireRate: 5.42, critChance: 0.26, critMul: 2.8, status: 0.14, magazine: 14, reload: 2.4, ammo: 540 },
  ...
  { id: "Miter", name: "miter", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 112.5], ["Puncture", 6.25], ["Impact", 6.25]], accuracy: 100, fireRate: 2.5, critChance: 0.1, critMul: 2, status: 0.25, magazine: 20, reload: 2, ammo: 72, prjSpeed: 60 },
  ...
  { id: "Mutalist Cernos", name: "mutalistCernos", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 5.63], ["Puncture", 5.63], ["Impact", 101.25]], accuracy: 16.7, fireRate: 1.67, critChance: 0.15, critMul: 2, status: 0.49, magazine: 1, reload: 0.6, ammo: 72, prjSpeed: 70 },
  ...
  { id: "Ogris", name: "ogris", tags: ["Gun", "Primary", "Rifle", "AssaultRifle", "Launcher"], dmg: [["Blast", 50]], accuracy: 100, fireRate: 1.5, critChance: 0.05, critMul: 2, status: 0.35, magazine: 5, reload: 2.5, ammo: 20, prjSpeed: 40 },
  { id: "Ogris (charged)", name: "ogris", rivenName: "Ogris", mode: "charged", tags: ["Gun", "Primary", "Rifle", "AssaultRifle", "Launcher", "Charge"], dmg: [["Blast", 300]], accuracy: 100, fireRate: 3.33, critChance: 0.05, critMul: 2, status: 0.35, magazine: 5, reload: 2.5, ammo: 20, prjSpeed: 40 },
  ...
  { id: "Paracyst", name: "paracyst", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Toxin", 33]], accuracy: 25, fireRate: 6.04, critChance: 0.1, critMul: 2, status: 0.3, magazine: 60, reload: 2, ammo: 540, prjSpeed: 70 },
  { id: "Paris", name: "paris", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 18], ["Puncture", 96], ["Impact", 6]], accuracy: 16.7, fireRate: 1.54, critChance: 0.15, critMul: 1.5, status: 0.1, magazine: 1, reload: 0.65, ammo: 72, prjSpeed: 70 },
  { id: "Paris (charged)", name: "paris", rivenName: "Paris", mode: "charged", tags: ["Gun", "Primary", "Rifle", "Bow", "Charge"], dmg: [["Slash", 27], ["Puncture", 144], ["Impact", 9]], accuracy: 16.7, fireRate: 2, critChance: 0.3, critMul: 2, status: 0.1, magazine: 1, reload: 0.7, ammo: 72, prjSpeed: 85 },
  { id: "Paris Prime", name: "parisPrime", rivenName: "Paris", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 22.75], ["Puncture", 104], ["Impact", 3.25]], accuracy: 16.7, fireRate: 1.43, critChance: 0.225, critMul: 2, status: 0.2, magazine: 1, reload: 0.7, ammo: 72, prjSpeed: 70 },
  ...
  { id: "Carmine Penta", name: "carminePenta", rivenName: "Penta", tags: ["Gun", "Primary", "Rifle", "AssaultRifle", "Launcher"], dmg: [["Blast", 350], ["Impact", 75]], accuracy: 100, fireRate: 2, critChance: 0.10, critMul: 2, status: 0.10, magazine: 10, reload: 2.5, ammo: 20, prjSpeed: 20 },
  ...
  { id: "Plinx", name: "plinx", tags: ["Gun", "Secondary"], dmg: [["Heat", 20], ["Puncture", 26]], accuracy: 50, fireRate: 3.33, critChance: 0.32, critMul: 3, status: 0.04, magazine: 10, reload: 0.8, ammo: 210 },
  { id: "Prisma Angstrum", name: "prismaAngstrum", rivenName: "Angstrum", tags: ["Gun", "Secondary", "SecondUnique"], dmg: [["Cold", 225], ["Heat", 225]], accuracy: 26.7, fireRate: 1, critChance: 0.18, critMul: 2.2, status: 0.26, magazine: 3, reload: 1.8, ammo: 18 },
  ...
  { id: "Quartakk", name: "quartakk", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 16.7], ["Puncture", 14.2], ["Impact", 18.1]], accuracy: 90.9, fireRate: 6.327, critChance: 0.19, critMul: 2.3, status: 0.27, magazine: 84, reload: 1.9, ammo: 540 },
  { id: "Rakta Cernos", name: "raktaCernos", rivenName: "Cernos", tags: ["Gun", "Primary", "Rifle", "Bow"], dmg: [["Slash", 6.25], ["Puncture", 6.25], ["Impact", 112.5]], accuracy: 16.7, fireRate: 1.67, critChance: 0.35, critMul: 2, status: 0.15, magazine: 1, reload: 0.6, ammo: 72 },
  ...
  { id: "Rubico", name: "rubico", tags: ["Gun", "Primary", "Rifle", "Sniper"], dmg: [["Slash", 9], ["Puncture", 27], ["Impact", 144]], accuracy: 0, fireRate: 2.67, critChance: 0.3, critMul: 3, status: 0.12, magazine: 5, reload: 2.4, ammo: 72 },
  ...
  { id: "Scourge (charged)", name: "scourge", rivenName: "Scourge", mode: "charged", tags: ["Gun", "Primary", "Rifle", "AssaultRifle", "Charge"], dmg: [["Slash", 122.5], ["Puncture", 72.5], ["Impact", 455]], accuracy: 100, fireRate: 2, critChance: 0.04, critMul: 2, status: 0.3, magazine: 20, reload: 2.5, ammo: 540 },
  ...
  { id: "Snipetron", name: "snipetron", tags: ["Gun", "Primary", "Rifle", "Sniper"], dmg: [["Slash", 17.5], ["Puncture", 140], ["Impact", 17.5]], accuracy: 13.3, fireRate: 2, critChance: 0.3, critMul: 1.5, status: 0.12, magazine: 4, reload: 3.5, ammo: 72 },
  ...
  { id: "Stug", name: "stug", tags: ["Gun", "Secondary", "SecondUnique"], dmg: [["Toxin", 78], ["Electricity", 78]], accuracy: 100, fireRate: 4, critChance: 0.05, critMul: 1.5, status: 0, magazine: 20, reload: 2, ammo: 210, prjSpeed: 35 },
  ...
  { id: "Sybaris", name: "sybaris", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 27.2], ["Puncture", 26.4], ["Impact", 26.4]], accuracy: 28.6, fireRate: 4, critChance: 0.25, critMul: 2, status: 0.1, magazine: 10, reload: 2, ammo: 540 },
  { id: "Sybaris Prime", name: "sybarisPrime", rivenName: "Sybaris", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 29.9], ["Puncture", 29], ["Impact", 29]], accuracy: 25, fireRate: 4.762, critChance: 0.3, critMul: 2, status: 0.25, magazine: 20, reload: 2, ammo: 540 },
  ...
  { id: "Talons", name: "talons", tags: ["Gun", "Secondary", "Thrown", "SecondUnique"], dmg: [["Cold", 60], ["Heat", 60]], accuracy: 100, fireRate: 5, critChance: 0.22, critMul: 2, status: 0.26, magazine: 4, reload: 1, ammo: 12, prjSpeed: 25 },
  ...
  { id: "Tenora (charged)", name: "tenora", rivenName: "Tenora", mode: "charged", tags: ["Gun", "Primary", "Rifle", "AssaultRifle", "Charge"], dmg: [["Slash", 48], ["Puncture", 144], ["Impact", 48]], accuracy: 12.5, fireRate: 1.25, critChance: 0.33, critMul: 3, status: 0.11, magazine: 150, reload: 2.5, ammo: 900 },
  { id: "Tetra", name: "tetra", tags: ["Gun", "Primary", "Rifle"], dmg: [["Puncture", 6.4], ["Impact", 25.6]], accuracy: 18.2, fireRate: 6.67, critChance: 0.04, critMul: 1.5, status: 0.2, magazine: 60, reload: 2, ammo: 540, prjSpeed: 100 },
  ...
  { id: "Tiberon", name: "tiberon", tags: ["Gun", "Primary", "Rifle"], dmg: [["Slash", 11], ["Puncture", 22], ["Impact", 11]], accuracy: 33.3, fireRate: 9.006, critChance: 0.26, critMul: 2.4, status: 0.16, magazine: 30, reload: 2.3, ammo: 540 },
  ...
  { id: "Torid", name: "torid", tags: ["Gun", "Primary", "Rifle", "AssaultRifle", "Launcher"], dmg: [["Toxin", 100]], accuracy: 100, fireRate: 1.5, critChance: 0.15, critMul: 2, status: 0.2, magazine: 5, reload: 1.7, ammo: 60, prjSpeed: 25 },
  ...
  { id: "Vectis", name: "vectis", tags: ["Gun", "Primary", "Rifle", "Sniper"], dmg: [["Slash", 56.3], ["Puncture", 78.8], ["Impact", 90]], accuracy: 13.3, fireRate: 1.11, critChance: 0.25, critMul: 2, status: 0.3, magazine: 1, reload: 0.9, ammo: 72 },
  ...
  { id: "Veldt", name: "veldt", tags: ["Gun", "Primary", "Rifle", "AssaultRifle"], dmg: [["Slash", 43.2], ["Puncture", 23.4], ["Impact", 23.4]], accuracy: 25, fireRate: 3.67, critChance: 0.22, critMul: 2.2, status: 0.22, magazine: 16, reload: 1.6, ammo: 528 },
