...
export const GunWeaponDataBase: GunWeapon[] = ([
  ...
  { id: "Simulor", name: "simulor", tags: ["Gun", "Primary", "Rilfe", "AssaultRifle"], dmg: [["Magnetic", 75]], accuracy: 100, fireRate: 3, critChance: 0.12, critMul: 2, status: 0.3, magazine: 8, reload: 3, ammo: 60 },
  { id: "Synoid Simulor", name: "synoidSimulor", rivenName: "Simulor", tags: ["Gun", "Primary", "Rilfe", "AssaultRifle"], dmg: [["Magnetic", 75]], accuracy: 100, fireRate: 3.33, critChance: 0.14, critMul: 2, status: 0.35, magazine: 16, reload: 2, ammo: 75 },
  ...
  { id: "Tonkor", name: "tonkor", tags: ["Gun", "Primary", "Rilfe", "AssaultRifle", "Launcher"], dmg: [["Blast", 650], ["Puncture", 75]], accuracy: 12.5, fireRate: 3.17, critChance: 0.25, critMul: 2.5, status: 0.1, magazine: 1, reload: 1.7, ammo: 30, prjSpeed: 30 },
