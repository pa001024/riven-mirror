...
const data = [
  ...
  ["Wb", "Sacrifice", [["Sentinel takes 7s to revive its downed owner to 25% health and shields, destroying itself after the process."]], Sentinel, "y", "r", 6, 3],
  ...
  ["X0", "Whiplash Mine", [["Deploys a mine that tethers all enemies in 5m. After 3s, all enemies still in range get pulled to the mine."]], MOA, "y", "n", 2, 3],
  ["X2", "Shockwave Actuators", [["Readies a shockwave every 60s that knocks down nearby enemies."]], MOA, "y", "n", 2, 3],
  ["X1", "Stasis Field", [["Creates a stasis field for 5s. While inside the field, all enemy projectiles move 15% slower and deal 10% less Damage."]], MOA, "y", "n", 4],
  ["X3", "Anti-Grav Grenade", [["A grenade that reverses gravity in a 1m radius, inflicting 20 Impact Damage. Target sustains additional damage based on the amount sustained while airborne."]], MOA, "y", "n", 2, 3],
  ["X4", "Security Override", [["Auto-hacks consoles over 12s. 5% chance to mind control basic robotic enemies and turrets in 30m for 4s after Hacking."]], MOA, "y", "n", 2],
  ...
  ["X7", "Proboscis", [["Helminth Charger whips a proboscis out at an enemy within 15m, pulling them back and dealing 25 damage."]], "Helminth Charger", "y", "r", 0, 3],
  ["XK", "Strain Fever", [["Helminth Charger gains +7% Damage per Cyst."]], "Helminth Charger", "r", "r", 6, 3],
  ["XL", "Strain Eruption", [["Increased Pistol Ammo recovery."], ["Maggots explode on death, dealing 1% of an enemy's current Health as Corrosive Damage to any enemy within 2m."]], "Helminth Charger", "-", "r", 2, 3],
  ...
  ["XI", "Mischief", [["Allows Smeeta Kavat to become invisible for 6s every 10s while a decoy kavat draws fire. Decoy has a 0% chance to evade damage."]], "Smeeta Kavat", "y", "r", 0, 3],

  ["XU", "Neutralize", [["The kubrow bites the hand of an enemy within 10m, causing them to drop their weapon."]], "Chesa Kubrow", "y", "r", 0],
  ["XS", "Retrieve", [["Kubrow has 7.5% chance to scavenge additional loot from a fallen enemy or containers within 5m, every 10s."]], "Chesa Kubrow", "y", "n", 0],
