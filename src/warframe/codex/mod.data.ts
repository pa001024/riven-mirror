...
const data = [
  ...
  ["08", "Proton Jet", [["onWalllatch"], ["0", 25], ["2", 25]], Primary, "-", "c", 4, 3],
  ...
  [
    ...
    [
      [
        "The infested mass accumulates 50% of the damage that goes through it and deals it in 15m radius when it expires. Secondary fire will manually detonate an existing mass.",
      ],
    ],
    "Mutalist Quanta",
    "-",
  ...
  [
    ...
    [["L", 7.5], ["Parrying with a Shield reflects +1000% Damage"], ["+15% Channeling Efficiency while Parrying"]],
    "Javlok",
    "-",
    "r",
    6,
  ...
  [
    ...
    [["P", 0.5], ["Damage from daggers reduces Armor by +1."], ["Enemies are revealed by Punch Through."]],
    "Argonak",
    "-",
    "r",
    6,
  ...
  [
    "DA",
    "Avenging Truth",
    [["Blocking absorbs 20% of incoming damage, stored as extra damage for the next charge attack."], ["vt", 0.3]],
    "Silva & Aegis",
    "r",
    "r",
    4,
  ...
  ["DH", "Vulcan Blitz", [["Enemies explode on death, dealing 50 Blast Damage (+10% Enemy Max Health) in a 1m radius."]], "Jat Kittag", "r", "c", 4],
  ["DI", "Static Discharge", [["Charge Attacks electrify nearby enemies for Electricity Damage equal to 30% of weapon damage."]], "Prova", "-", "r", 2],
  ...
  ["DN", "Proton Snap", [["Hold Wall Latch for 2s to gain +25% Toxin Damage"], [" and +12.5% Status Chance for 5s."]], Melee, "r", "r", 6, 3],
  ...
  [
    ...
    [["N", 2.5], ["+3% Blast Radius on Specialized Launchers"], ["Melee kills knockdown enemies within 2.5m"]],
    "Furax",
    "-",
    "r",
    6,
  ...
  // 机器
  ["Wr", "Coolant Leak", [["Sentinel has a 3m freeze aura, slowing incoming enemies by 10%."]], Robotic, "y", "r", 4, 0],
  ...
  [
    "Wb",
    "Sacrifice",
    [["Sentinel takes 7s to revive its downed owner to 25% health and shields, destroying itself after the process."]],
    Sentinel,
    "y",
    "r",
    6,
  ...
  ["WB", "Self Destruct", [["Explodes on death, dealing 100 Blast Damage in a 3m radius and knocking down nearby enemies."]], Sentinel, "r", "r", 2],
  ...
  [
    "X0",
    "Whiplash Mine",
    [["Deploys a mine that tethers all enemies in 5m. After 3s, all enemies still in range get pulled to the mine."]],
    MOA,
    "y",
    "n",
    2,
  ...
  ["X2", "Shockwave Actuators", [["Readies a shockwave every 60s that knocks down nearby enemies."]], MOA, "y", "n", 2, 3],
  [
    "X1",
    "Stasis Field",
    [["Creates a stasis field for 5s. While inside the field, all enemy projectiles move 15% slower and deal 10% less Damage."]],
    MOA,
    "y",
    "n",
    4,
  ...
  [
    ...
    [
      [
        "A grenade that reverses gravity in a 1m radius, inflicting 20 Impact Damage. Target sustains additional damage based on the amount sustained while airborne.",
      ],
    ],
    MOA,
    "y",
  ...
  [
    "X4",
    "Security Override",
    [["Auto-hacks consoles over 12s. 5% chance to mind control basic robotic enemies and turrets in 30m for 4s after Hacking."]],
    MOA,
    "y",
    "n",
    2,
  ...
  ["W4", "Hunter Command", [["Applying a Slash Status to an enemy causes the Companion to attack them"], ["over", 1]], Beast, "r", "r", 4],
  ["X6", "Shelter", [["Creates a shield with 100 Health around the player when they are reviving fallen allies."]], Beast, "d", "c", 6, 10],
  ...
  ["X9", "Tek Enhance", [["+5% Kavat Ability Duration"]], Kavat, "r", "r", 6],
  ...
  [
    "X7",
    "Proboscis",
    [["Helminth Charger whips a proboscis out at an enemy within 15m, pulling them back and dealing 25 damage."]],
    "Helminth Charger",
    "y",
    "r",
    0,
  ...
  ["XK", "Strain Fever", [["Helminth Charger gains +7% Damage per Cyst."]], "Helminth Charger", "r", "r", 6, 3],
  [
    "XL",
    "Strain Eruption",
    [["Increased Pistol Ammo recovery."], ["Maggots explode on death, dealing 1% of an enemy's current Health as Corrosive Damage to any enemy within 2m."]],
    "Helminth Charger",
    "-",
    "r",
    2,
  ...
  ["XJ", "Cat's Eye", [["Adarza Kavat grants 15% increased critical chance for 4s to allies within 15m every 50s."]], "Adarza Kavat", "y", "r", 0, 3],
  ["XE", "Reflect", [["Adarza Kavat has a 10% chance to reflect damage back to an enemy, amplifying it by 15%."]], "Adarza Kavat", "y", "r", 0, 3],

  ["XH", "Charm", [["Smeeta Kavat has a 7% chance every 30s to bestow its owner with good fortune."]], "Smeeta Kavat", "y", "r", 0, 3],
  [
    "XI",
    "Mischief",
    [["Allows Smeeta Kavat to become invisible for 6s every 10s while a decoy kavat draws fire. Decoy has a 0% chance to evade damage."]],
    "Smeeta Kavat",
    "y",
    "r",
    0,
  ...
  ["XU", "Neutralize", [["The kubrow bites the hand of an enemy within 10m, causing them to drop their weapon."]], "Chesa Kubrow", "y", "r", 0],
  [
    "XS",
    "Retrieve",
    [["Kubrow has 7.5% chance to scavenge additional loot from a fallen enemy or containers within 5m, every 10s."]],
    "Chesa Kubrow",
    "y",
    "n",
    0,
  ...
  ["XX", "Hunt", [["The kubrow charges ahead to attack an enemy, dealing 35 Damage to all in its path."]], "Huras Kubrow", "y", "r", 0],
  ["XW", "Stalk", [["The kubrow cloaks itself and its master to stalk down its prey when they are within 14m."]], "Huras Kubrow", "y", "r", 0],

  ["XT", "Howl", [["The kubrow cries out with a blood-curdling howl that strikes fear into 5 enemies within 4m for 6s."]], "Raksa Kubrow", "y", "r", 0],
  ["XR", "Protect", [["The kubrow comes to the defense of its master, replenishing their shields by 91."]], "Raksa Kubrow", "y", "r", 0],

  ["XV", "Dig", [["The kubrow sniffs out buried objects and digs them up."], ["+45% Success Chance"]], "Sahasa Kubrow", "y", "r", 0],
  ["XO", "Ferocity", [["Allows the Kubrow to use Finisher attacks on an enemy."], ["X", 20]], "Sahasa Kubrow", "y", "r", 0],

  ["XP", "Savagery", [["Allows the Kubrow to use Finisher attacks on an enemy."], ["X", 20]], "Sunika Kubrow", "y", "r", 0],
  ["XQ", "Unleashed", [["The kubrow grapples a VIP target within 35m, forcing them to the ground."]], "Sunika Kubrow", "y", "r", 0],
