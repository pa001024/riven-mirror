...
const data = [
  ...
  ["W5", "Accelerated Deflection", [["r", 15]], "Companion", "d", "c", 4],
  ...
  ["WE", "Hastened Deflection", [["r", 15]], "Companion", "d", "c", 4],
  ...
  ["WG", "Maul", [["K", 30]], "Companion", "r", "c", 4, 10],
  ...
  ["WS", "Detect Vulnerability", [["Upon completing research on an enemy, subsequent scans will reveal their weak points.", 0]], "Companion", "y", "r", 6],
  ["WT", "Vaporize", [["Sentinel will deal 150 Damage to an enemy within 2.3m.", 0]], "Companion", "y", "n", 2],
  ["WU", "Vacuum", [["6.5m Companion Gather-Link. Detects and collects items, including mods.", 0]], "Companion", "y", "n", 2],
  ["WV", "Thumper", [["Djinn will attack the first visible enemy within 35m.", 0]], "Companion", "y", "n", 0],
  ["WW", "Targeting Receptor", [["Causes the Helios Sentinel to attack targets within 10m with 1 glaives.", 0]], "Companion", "y", "n", 0, 3],
  ["WX", "Electro Pulse", [["Every 10s, Sentinel will continually zap an enemy within 15m, trapping them in a stunned state.", 0]], "Companion", "y", "n", 2],
  ["WY", "Molecular Conversion", [["Blast enemies within 10m, converting 50 Damage into Shields for the Warframe.", 0]], "Companion", "y", "n", 2],
  ["WZ", "Assault Mode", [["Sentinel will attack first visible enemy within 17.5m.", 0]], "Companion", "y", "n", 0],
  ...
  ["Wb", "Sacrifice", [["Sentinel takes 7s to revive its downed owner to 25% health and shields, destroying itself after the process.", 0]], "Companion", "y", "r", 6, 3],
  ["Wc", "Revenge", [["Sentinel will not attack an enemy unless that enemy has attacked the Sentinel's master within 5.8m.", 0]], "Companion", "y", "n", 0],
  ["Wd", "Reawaken", [["Upon death, automatically revives itself after 165s.", 0]], "Companion", "y", "r", 4],
  ["We", "Regen", [["If killed, regenerates 1x with 58% Max Health and is invulnerable for 1s.", 0]], "Companion", "y", "n", 2],
  ["Wf", "Negate", [["Sentinel prevents Status Effects from applying to its owner once every 15s.", 0]], "Companion", "y", "r", 4],
  ["Wg", "Primed Regen", [["If killed, regenerates 1x with 50% Max Health and is invulnerable for 1s.", 0]], "Companion", "y", "l", 4, 10],
  ["Wh", "Looter", [["Destroys loot crates within 4.5m.", 0]], "Companion", "y", "r", 2],
  ["Wi", "Scan Matter", [["Resource containers within 15m are revealed on the Minimap for 2s every 30s.", 0]], "Companion", "y", "n", 0, 3],
  ["Wj", "Ammo Case", [["Increases Ammo Capacity by 5% and converts Ammo Pickups into ammo for equipped weapons after 5s.", 0]], "Companion", "y", "n", 2],
  ["Wk", "Energy Generator", [["Dethcube drops an Energy Orb after assisting in 15 kills.", 0]], "Companion", "y", "r", 4],
  ["Wl", "Odomedic", [["Every 12m traversed by Wall Running regenerates +10 Health over 1s. This effect can stack up to 3x.", 0]], "Companion", "y", "r", 2, 3],
  ["Wm", "Calculated Shot", [["Sentinel charges a powerful shot and fires at the first enemy within 40.8m.", 0]], "Companion", "y", "n", 0],
  ["Wn", "Guardian", [["Boosts owner's shield by 58% when it runs out.", 0]], "Companion", "y", "n", 2],
  ["Wo", "Ambush", [["When Ghost invisibility is broken, Shade's owner is granted +30% Weapon Damage for 3s.", 0]], "Companion", "y", "r", 6, 3],
  ["Wp", "Ghost", [["Cloaks owner when enemies are within 5.8m. The cloak is disrupted if owner attacks.", 0]], "Companion", "y", "n", 2],
  ["Wq", "Crowd Dispersion", [["Unleashes a 6.0m radial knockdown when multiple enemies are nearby, dealing 6.0 Damage.", 0]], "Companion", "y", "n", 2],
  ["Wr", "Coolant Leak", [["Sentinel has a 3m freeze aura, slowing incoming enemies by 10%.", 0]], "Companion", "y", "r", 4, 0],
  ["Ws", "Investigator", [["Helios Sentinel will scan objects and enemies within 20m over 5s. This consumes codex scanner charges.", 0]], "Companion", "y", "n", 4],
  ["Wt", "Fetch", [["8.5m Companion Gather-Link. Detects and collects items, including mods.", 0]], "Companion", "y", "c", 2],
  ["Wu", "Fatal Attraction", [["Enemies within 10m will be attracted. Once they come within 3.5m, explode for 100 Damage.", 0]], "Companion", "y", "n", 2],
  ["Wv", "Arc Coil", [["Sentinel will zap up to 2 enemies within 10m, dealing 100 <DT_ELECTRICITY>Electricity Damage with a 10% Status Chance.", 0]], "Companion", "y", "n", 2],
  ["Ww", "Anti-Grav Array", [["Increase height of owner's jumps by +10%.", 0]], "Companion", "y", "r", 4, 3],
  ["Wx", "Medi-Ray", [["Sentinel will occasionally heal its owner, restoring 2% Health over 4s.", 0]], "Companion", "y", "c", 0],
  ["Wy", "Shield Charger", [["Increases Max Shields by 10% and Shield Regeneration by 10% for 5s.", 0]], "Companion", "y", "r", 0],
  ["Wz", "Tractor Beam", [["+20% Aim Glide Duration", 0], ["-12.5% Gravity", 0]], "Companion", "y", "n", 2, 3],
  ["X0", "Whiplash Mine", [["Deploys a mine that tethers all enemies in 5m. After 3s, all enemies still in range get pulled to the mine.", 0]], "Companion", "y", "n", 2, 3],
  ["X1", "Stasis Field", [["Creates a stasis field for 5s. While inside the field, all enemy projectiles move 15% slower and deal 10% less Damage.", 0]], "Companion", "y", "n", 4],
  ["X2", "Shockwave Actuators", [["Readies a shockwave every 60s that knocks down nearby enemies.", 0]], "Companion", "y", "n", 2, 3],
  ["X3", "Anti-Grav Grenade", [["A grenade that reverses gravity in a 1m radius, inflicting 20 <DT_IMPACT>Impact Damage. Target sustains additional damage based on the amount sustained while airborne.", 0]], "Companion", "y", "n", 2, 3],
