...
const data = [
  ...
  ["W1", "Synth Deconstruct", [["Enemies injured by the Sentinel have 2% chance to drop a Health Orb when killed.", 0]], "Companion", "r", "r", 4],
  ["W2", "Hunter Synergy", [["+5% Critical Chance-Link", 0]], "Companion", "r", "c", 4],
  ["W3", "Hunter Recovery", [["+5% Companion Lifesteal-Link", 0]], "Companion", "r", "n", 4],
  ["W4", "Hunter Command", [["Applying a <DT_SLASH>Slash Status to an enemy causes the Companion to attack them for 1s.", 0]], "Companion", "r", "r", 4],
  ["W5", "Accelerated Deflection", [["+15% Shield Recharge", 0]], "Companion", "d", "c", 4],
  ["W6", "Calculated Redirection", [["+25% Shield Capacity", 0]], "Companion", "d", "n", 4, 10],
  ["W7", "Fired Up", [["+10% <DT_FIRE>Heat at Max Overheat", 0]], "Companion", "r", "r", 6],
  ["W8", "Animal Instinct", [["lr", 5], ["er", 3]], "Companion", "-", "r", 6],
  ["W9", "Primed Animal Instinct", [["lr", 5], ["er", 3]], "Companion", "-", "l", 6, 10],
  ["WA", "Enhanced Vitality", [["+20% Health", 0]], "Companion", "d", "n", 2, 10],
  ["WB", "Self Destruct", [["Explodes on death, dealing 100 <DT_EXPLOSION>Blast Damage in a 3m radius and knocking down nearby enemies.", 0]], "Companion", "r", "r", 2],
  ["WC", "Spare Parts", [["+7.5% Rare Item Drop Chance On Death", 0]], "Companion", "-", "c", 2],
  ["WD", "Metal Fiber", [["+10% Armor", 0]], "Companion", "d", "n", 4, 10],
  ["WE", "Hastened Deflection", [["+15% Shield Recharge", 0]], "Companion", "d", "c", 4],
  ["WF", "Pack Leader", [["Heals your pet by a percentage of the damage you deal with Melee Attacks.", 0], ["+6% Lifesteal-Link", 0]], "Companion", "r", "n", 4],
  ["WG", "Maul", [["+30% Melee Damage", 0]], "Companion", "r", "c", 4, 10],
  ["WH", "Loyal Companion", [["+15% Bleedout-Link", 0]], "Companion", "d", "n", 2],
  ["WI", "Link Shields", [["+10% Shield-Link", 0]], "Companion", "d", "c", 4, 10],
  ["WJ", "Link Health", [["+15% Health-Link", 0]], "Companion", "d", "c", 2, 10],
  ["WK", "Link Armor", [["+10% Armor-Link", 0]], "Companion", "d", "c", 4, 10],
  ["WL", "Bite", [["0", 30], ["1", 20]], "Companion", "r", "r", 6, 10],
  ["WM", "Primed Pack Leader", [["Heals your pet by a percentage of the damage you deal with Melee Attacks.", 0], ["+6% Lifesteal-Link", 0]], "Companion", "r", "l", 4, 10],
  ["WN", "Venom Teeth", [["6", 15], ["2", 15]], "Companion", "r", "r", 4, 3],
  ["WO", "Frost Jaw", [["5", 15], ["2", 15]], "Companion", "r", "r", 4, 3],
  ["WP", "Flame Gland", [["4", 15], ["2", 15]], "Companion", "r", "r", 4, 3],
  ["WQ", "Shock Collar", [["7", 15], ["2", 15]], "Companion", "r", "r", 4, 3],
  ["WR", "Medi-Pet Kit", [["hps", 1], ["br", 12]], "Companion", "d", "r", 4],
  ["WS", "Detect Vulnerability", [["Upon completing research on an enemy, subsequent scans will reveal their weak points.", 0]], "Companion", "k", "r", 6],
  ["WT", "Vaporize", [["Sentinel will deal 150 Damage to an enemy within 2.3m.", 0]], "Companion", "k", "n", 2],
  ["WU", "Vacuum", [["6.5m Companion Gather-Link. Detects and collects items, including mods.", 0]], "Companion", "k", "n", 2],
  ["WV", "Thumper", [["Djinn will attack the first visible enemy within 35m.", 0]], "Companion", "k", "n", 0],
  ["WW", "Targeting Receptor", [["Causes the Helios Sentinel to attack targets within 10m with 1 glaives.", 0]], "Companion", "k", "n", 0, 3],
  ["WX", "Electro Pulse", [["Every 10s, Sentinel will continually zap an enemy within 15m, trapping them in a stunned state.", 0]], "Companion", "k", "n", 2],
  ["WY", "Molecular Conversion", [["Blast enemies within 10m, converting 50 Damage into Shields for the Warframe.", 0]], "Companion", "k", "n", 2],
  ["WZ", "Assault Mode", [["Sentinel will attack first visible enemy within 17.5m.", 0]], "Companion", "k", "n", 0],
  ["Wa", "Sanctuary", [["Creates a shield with 100 Health around the player when they are reviving fallen allies.", 0]], "Companion", "d", "r", 6, 10],
  ["Wb", "Sacrifice", [["Sentinel takes 7s to revive its downed owner to 25% health and shields, destroying itself after the process.", 0]], "Companion", "k", "r", 6, 3],
  ["Wc", "Revenge", [["Sentinel will not attack an enemy unless that enemy has attacked the Sentinel's master within 5.8m.", 0]], "Companion", "k", "n", 0],
  ["Wd", "Reawaken", [["Upon death, automatically revives itself after 165s.", 0]], "Companion", "k", "r", 4],
  ["We", "Regen", [["If killed, regenerates 1x with 58% Max Health and is invulnerable for 1s.", 0]], "Companion", "k", "n", 2],
  ["Wf", "Negate", [["Sentinel prevents Status Effects from applying to its owner once every 15s.", 0]], "Companion", "k", "r", 4],
  ["Wg", "Primed Regen", [["If killed, regenerates 1x with 50% Max Health and is invulnerable for 1s.", 0]], "Companion", "k", "l", 4, 10],
  ["Wh", "Looter", [["Destroys loot crates within 4.5m.", 0]], "Companion", "k", "r", 2],
  ["Wi", "Scan Matter", [["Resource containers within 15m are revealed on the Minimap for 2s every 30s.", 0]], "Companion", "k", "n", 0, 3],
  ["Wj", "Ammo Case", [["Increases Ammo Capacity by 5% and converts Ammo Pickups into ammo for equipped weapons after 5s.", 0]], "Companion", "k", "n", 2],
  ["Wk", "Energy Generator", [["Dethcube drops an Energy Orb after assisting in 15 kills.", 0]], "Companion", "k", "r", 4],
  ["Wl", "Odomedic", [["Every 12m traversed by Wall Running regenerates +10 Health over 1s. This effect can stack up to 3x.", 0]], "Companion", "k", "r", 2, 3],
  ["Wm", "Calculated Shot", [["Sentinel charges a powerful shot and fires at the first enemy within 40.8m.", 0]], "Companion", "k", "n", 0],
  ["Wn", "Guardian", [["Boosts owner's shield by 58% when it runs out.", 0]], "Companion", "k", "n", 2],
  ["Wo", "Ambush", [["When Ghost invisibility is broken, Shade's owner is granted +30% Weapon Damage for 3s.", 0]], "Companion", "k", "r", 6, 3],
  ["Wp", "Ghost", [["Cloaks owner when enemies are within 5.8m. The cloak is disrupted if owner attacks.", 0]], "Companion", "k", "n", 2],
  ["Wq", "Crowd Dispersion", [["Unleashes a 6.0m radial knockdown when multiple enemies are nearby, dealing 6.0 Damage.", 0]], "Companion", "k", "n", 2],
  ["Wr", "Coolant Leak", [["Sentinel has a 3m freeze aura, slowing incoming enemies by 10%.", 0]], "Companion", "k", "r", 4, 0],
  ["Ws", "Investigator", [["Helios Sentinel will scan objects and enemies within 20m over 5s. This consumes codex scanner charges.", 0]], "Companion", "k", "n", 4],
  ["Wt", "Fetch", [["8.5m Companion Gather-Link. Detects and collects items, including mods.", 0]], "Companion", "k", "c", 2],
  ["Wu", "Fatal Attraction", [["Enemies within 10m will be attracted. Once they come within 3.5m, explode for 100 Damage.", 0]], "Companion", "k", "n", 2],
  ["Wv", "Arc Coil", [["Sentinel will zap up to 2 enemies within 10m, dealing 100 <DT_ELECTRICITY>Electricity Damage with a 10% Status Chance.", 0]], "Companion", "k", "n", 2],
  ["Ww", "Anti-Grav Array", [["Increase height of owner's jumps by +10%.", 0]], "Companion", "k", "r", 4, 3],
  ["Wx", "Medi-Ray", [["Sentinel will occasionally heal its owner, restoring 2% Health over 4s.", 0]], "Companion", "k", "c", 0],
  ["Wy", "Shield Charger", [["Increases Max Shields by 10% and Shield Regeneration by 10% for 5s.", 0]], "Companion", "k", "r", 0],
  ["Wz", "Tractor Beam", [["+20% Aim Glide Duration", null], ["-12.5% Gravity", null]], "Companion", "k", "n", 2, 3],
  ["X0", "Whiplash Mine", [["Deploys a mine that tethers all enemies in 5m. After 3s, all enemies still in range get pulled to the mine.", 0]], "Companion", "k", "n", 2, 3],
  ["X1", "Stasis Field", [["Creates a stasis field for 5s. While inside the field, all enemy projectiles move 15% slower and deal 10% less Damage.", 0]], "Companion", "k", "n", 4],
  ["X2", "Shockwave Actuators", [["Readies a shockwave every 60s that knocks down nearby enemies.", 0]], "Companion", "k", "n", 2, 3],
  ["X3", "Anti-Grav Grenade", [["A grenade that reverses gravity in a 1m radius, inflicting 20 <DT_IMPACT>Impact Damage. Target sustains additional damage based on the amount sustained while airborne.", 0]], "Companion", "k", "n", 2, 3],
  ["X4", "Security Override", [["Auto-hacks consoles over 12s. 5% chance to mind control basic robotic enemies and turrets in 30m for 4s after Hacking.", 0]], "Companion", "k", "n", 2],
  ["X5", "Scavenge", [["+15% chance for the pet to pry open a locked locker.", 0]], "Companion", "k", "n", 0],
