...
const _enemyList = [
  ["Eidolon Teralyst", "夜灵兆力使", 5, 1, 15000, 2500, 200, 7, 0, 1, 0.90, 2],
  ["Eidolon Gantulyst", "夜灵巨力使", 5, 1, 15000, 2500, 200, 7, 0, 1, 0.90, 2],
  ["Eidolon Hydrolyst", "夜灵水力使", 5, 1, 15000, 2500, 200, 7, 0, 1, 0.90, 2],
  ["Teralyst Synovia", "兆力使骨液", 5, 1, 3000, 0, 200, 7, 0, 1, 0.90, 2],
