...
const _arcaneListSource = [
  ...
  ["Acceleration", "加速", ["R", 0.6], "造成暴击", "Rilfe", 0.2, 6],
  ["Avenger", "复仇者", ["加法暴击", 0.3], "受到伤害", "武器", 0.14, 8],
  ["Awakening", "觉醒", ["D", 1], "装弹", "Secondary", 0.4, 16],
  ["Fury", "狂怒", ["K", 1.2], "造成暴击", "Melee", 0.4, 12],
  ["Strike", "速攻", ["J", 0.4], "击中", "Melee", 0.1, 12],
  ["Momentum", "动量", ["F", 1], "造成暴击", "Sniper", 0.4, 8],
  ["Precision", "精确", ["D", 1.2], "造成爆头", "Secondary", 0.8, 8],
  ["Rage", "愤怒", ["D", 0.1], "造成爆头", "Primary", 0.1, 16],
  ["Tempo", "节奏", ["R", 0.6], "造成暴击", "Shotgun", 0.1, 8],
  ["Velocity", "迅速", ["R", 0.8], "造成暴击", "Secondary", 0.6, 6],
