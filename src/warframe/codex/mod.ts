...
const _normalModSource = [
  ...
  ["Cw", "Power Throw", "奋力一掷", [["P", 0.6]], "增加投掷武器的穿透 （如战刃, 战刃 Prime, 哈利卡,和红隼），对其他武器无效", "投掷武器", "r", "r", 9],
  ["Cx", "Quick Return", "快速收回", [["弹跳", -4]], "减少投掷武器（如战刃, 战刃 Prime, 哈利卡,和红隼）的弹跳次数", "投掷武器", "-", "n", 7],
  ["Cy", "Rebound", "弹跳", [["弹跳", 4]], "增加投掷武器（如战刃, 战刃 Prime, 哈利卡,和红隼）的弹跳次数", "投掷武器", "-", "n", 7],
  ["Cz", "Whirlwind", "旋风", [["飞行速度", 1.8]], "增加投掷武器（如战刃, 战刃 Prime, 哈利卡,和红隼）的飞行速度", "投掷武器", "-", "r", 7],
