...
const _normalModSource = [
  ...
  ["1O", "adhesiveBlast", [["壁面附着", 1]], "特定武器", "r", "r", 9],
  ["1P", "sinisterReach", [["射程", 12]], "喷射型武器", "-", "c", 5],
  ...
  ["1k", "combustionBeam", [["一段时间后敌人爆炸", 600]], "喷射型武器", "r", "r", 9],
  ["1l", "firestorm", [["增加爆炸半径", 0.24]], "特定武器", "r", "r", 9],
  ...
  ["1r", "kineticRicochet", [["魔改", 1]], "特拉", "-", "r", 7],
  ["1s", "tetherGrenades", [["魔改", 1]], "潘塔系列武器", "-", "c", 9],
  ...
  ["24", "entropyBurst", [["加基础状态触发率", 20]], "苏普拉", "r", "r", 7],
  ["25", "lastingPurity", [["正中红心", 0.6]], "金工火神", "-", "r", 7],
  ["26", "nightwatchNapalm", [["魔改", 1]], "食人女魔", "r", "r", 9],
  ["27", "fluxOverdrive", [["魔改", 0]], "通量射线步枪", "r", "c", 9],
  ["28", "neutralizingJustice", [["魔改", 1]], "米特尔", "d", "r", 7],
  ["29", "voltageSequence", [["电击陷阱", 1]], "兰卡", "-", "r", 7],
  ["2A", "disarmingPurity", [["缴械", 0.4]], "猎豹", "-", "r", 7],
  ["2B", "deadlySequence", [["0", 2]], "葛恩火枪", "r", "r", 7],
  ["2C", "gildedTruth", [["R", 0.8]], "伯斯顿 Prime", "r", "r", 7],
  ["2D", "springLoadedBroadhead", [["最终伤害", 0.4]], "大久和弓", "r", "r", 15],
  ...
  ["5b", "shatteringJustice", [["加法触发", 0.2]], "鳄神", "-", "r", 7],
  ...
  ["5s", "acidShells", [["魔改", 450]], "鳄神", "r", "c", 9],
  ["5t", "fomorianAccelerant", [["F", 0.6], ["反弹", 4]], "龙骑兵", "r", "c", 7],
  ...
  ["9q", "erodingBlight", [["L", 2]], "安柏勒斯", "d", "r", 7],
  ["9r", "stockpiledBlight", [["L", 2]], "苦无", "d", "r", 7],
  ["9s", "entropySpike", [["子弹爆炸几率", 0.2]], "螺钉手枪", "-", "r", 7],
  ["9t", "sequenceBurn", [["射程", 20]], "光谱切割器", "-", "r", 7],
  ["9u", "toxicSequence", [["3", 2]], "阿克里德", "d", "r", 7],
  ["9v", "windsOfPurity", [["生命窃取", 0.2]], "盗贼", "d", "r", 7],
  ["9w", "stingingTruth", [["弹匣", 40]], "蝰蛇", "d", "r", 7],
  ...
  ["CA", "berserker", [["J", 0.75]], "Melee", "r", "r", 9],
  ...
  ["D3", "justiceBlades", [["K", 1]], "斩肉双刀", "r", "r", 7],
  ["D4", "bladeOfTruth", [["K", 1]], "蛇颚刀", "r", "r", 7],
  ["D5", "gleamingBlight", [["2", 1]], "暗黑匕首", "-", "r", 7],
  ["D6", "toxicBlight", [["6", 1]], "米尔", "r", "r", 7],
  ["D7", "entropyFlight", [["飞行速度", 1.4]], "红隼", "-", "r", 7],
  ["D8", "entropyDetonation", [["处决的敌人爆炸", 1]], "奥比克斯", "-", "r", 7],
  ["D9", "brightPurity", [["处决的敌人爆炸", 1]], "空刃", "r", "r", 7],
  ["DA", "avengingTruth", [["格挡增加蓄力伤害", 1]], "席瓦 & 神盾", "r", "r", 7],
  ["DB", "electromagneticShielding", [["守护", 0.5]], "认知 & 冲击", "r", "r", 7],
  ["DC", "riftStrike", [["瞬移攻击", 25]], "双子巴萨克", "r", "r", 7],
