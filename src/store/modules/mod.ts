...
let state: State = {
  mod: new RivenMod(localStorage.getItem("lastMod") || "TGFua2F8MVNEfDE2fDIzM3wxIzEzNS41JlMjOTcuOSZEIzE3MS45JkgjLTQ3LjM", true),
...
const mutations = {
  newRiven(state: State, riven: RivenMod) {
    state.mod = riven;
    localStorage.setItem("lastMod", riven.qrCodeBase64);
