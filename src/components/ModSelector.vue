...
export default class ModSelector extends Vue {
  ...
  fastSelect = {
    Rifle: {
      ...
      goldGas: ["Thermite Rounds", "Malignant Force"],
    ...
    Shotgun: {
      ...
      goldGas: ["Scattering Inferno", "Toxic Barrage"],
    ...
    Secondary: {
      ...
      goldGas: ["Scorch", "Pistol Pestilence"],
    ...
    Melee: {
      ...
      goldGas: ["Volcanic Edge", "Virulent Scourge"],
    ...
    "Arch-Gun": {
      ...
      goldGas: ["Magma Chamber", "Contamination Casing"],
